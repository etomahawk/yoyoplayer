    ...
    <body>
        ...
        <div class="main_content">
            ...
            <div class="product_left">
                ...
                <div class="nav_class">
                    <ul>
                        <li><a href="../products/product_subnologin.jsp" class="hot">-> 金东铜版纸 </a></li>
            ...
            <div class="product_right">
                ...
                <div class="product_list">
                    <!--begin 第一列-->
                    <div 	class="col1">
                        <div class="pic"><a href="productInfo_nologin.jsp" target="_blank">
                                <img alt="img" src="../images/product1.jpg" width="81" height="90" border="0"/>
                            </a><br />
			  建发编码：21569</div>
                        <div class="info">
                            <ul>
                        ...
                        <div class="action">
                            ...
                            <input type="submit" name="Submit233" value=" 收 藏 " />&nbsp;&nbsp;<img alt="img" src="../images/tejia.gif" />
                        </div>
                    </div>
                    <div	class="col2">
