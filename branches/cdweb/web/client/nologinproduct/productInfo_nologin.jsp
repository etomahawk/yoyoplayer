            ...
            <div class="product_left">
                ...
                <div class="nav_class">
                    <ul>
                        ...
                        <li><a href="../products/product1.jsp" > --> 铜版纸</a></li>
                        <li><a href="#"> --> 白板纸</a></li>
                        <li> <a href="#">--> 白卡纸</a></li>
                        <li> <a href="#">--> 双胶纸</a></li>
                        <li><a href="#"> --> 轻涂纸</a></li>
                ...
                <div class="nav_class"><a href="../products/product2.html">双面铜版纸</a> <a href="../products/product2.html">单面铜版纸</a></div>
                <div class="blank23"></div>

                <div class="nav_title">品牌</div>
                <div class="nav_class"><a href="../products/product3.html">长鹤</a> 神盾 太空梭 东帆 无品牌 </div>
                <div class="blank23"></div>
            ...
            <div class="product_right">
                ...
                <div class="product_list">
                    ...
                    <div 	class="productinfo">
                        <div class="pic">
                            <a href="../products/productInfo.jsp" target="_blank"><img alt="img" src="../images/product1.jpg" width="81" height="90" border="0"  /></a><br /> 建发编码：21569
                        </div>
                        <div class="info">
                            <ul>
                                <li>商品：金东铜版纸</li>
