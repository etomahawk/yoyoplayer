    ...
    <body>
        ...
        <div class="main_content">
            ...
            <div class="product_left">
                <div class="nav_title"><span class="span1">品牌</span><span class="span2"><a href="#"><img alt="img" src="../images/icon_1.gif" border="0"/></a></span></div>
                <div class="nav_class"   style="display:none;">
                    <ul>
                        <li><a href="subproduct.jsp" >-> 金东铜版纸 </a></li>
                ...
                <div class="blank23"></div>
                <div class="nav_title"><span class="span1">品名</span><span class="span2"><a href="#"><img alt="img" src="../images/icon_2.gif" border="0"/></a></span></div>
                <div class="blank23"></div>
                ...
                <div class="blank23"></div>
                <div class="nav_title">等级</div>
                <div class="nav_class">A 合格 一等品 A类等外品 L 特级 正品 副品 二等品</div>
                <div class="blank23"></div>

                <div class="nav_title">件重</div>
                <div class="nav_class">0.82 0.61 0.76 0.95 0.86 0.75 0.72 0.71 0.89 0.80 0.72 0.66</div>
            ...
            <div class="product_right">
                ...
                <div class="product_list">
                    ...
                    <div 	class="col1">
                        ...
                        <div class="action">
                            <input type="submit" name="Submit43" value=" 选 购 " class="btn_2"  onclick="window.location.href='../order/car_list.jsp'"/>&nbsp;&nbsp;
                            <input type="submit" name="Submit233" value=" 收 藏 " class="btn_2" />&nbsp;&nbsp;<img alt="img" src="../images/tejia.gif" />
                        </div>
                    </div>
                    <div	class="col2">
                        <div class="pic"><img alt="img" src="../images/product1.jpg" width="81" height="90"  /><br />建发编码：21569</div>
                        ...
                        <div class="action">
                            <input type="submit" name="Submit43" value=" 选 购 " class="btn_2"  onclick="window.location.href='../order/car_list.jsp'"/>&nbsp;&nbsp;
                            <input type="submit" name="Submit233" value=" 收 藏 " class="btn_2" />
                        </div>
