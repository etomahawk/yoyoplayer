                ...
                <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="common_table">
                        <tbody>
                            ...
                            <tr class="common_value">
                                ...
                                <td height="25"><input id="tMale" name="rGender" value="tMale" type="radio" class="other_input"/>
                                    男
                                    <input id="tFemale" name="rGender" value="tFemale" checked="checked" type="radio" class="other_input"/>
                                    女 </td>
                            </tr>
                            <tr class="common_value2">
                            ...
                            <tr class="common_value">
                                ...
                                <td align="left"><input name="tbPhone" maxlength="60" id="tbPhone" type="text" />
                                    （请填写区号，如：021-54960808）联系电话和手机必填一项 </td>
                            </tr>
                            <tr class="common_value2">
